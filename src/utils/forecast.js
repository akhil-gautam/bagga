...
const forecast= (latitude, longitude,callback) => {
    ...
    request({url, json:true}, (error, {body}) =>{
        ...
        {
            callback(undefined,body.daily.data[0].summary + ' It\'s currently '+findCelsius(body.currently.temperature)+'° C out. There is a '+body.currently.precipProbability+'% chance of rain'
        )
    }
    })
}
